...
from utilidades.correo import enviar_correos, enviar_correo_soporte, enviar_correo_digitalizar
...
def generate_response():
    """
    Recibe un prompt y el historial de chat, y genera una respuesta usando OpenAI.
    1. Valida que prompt_user no esté vacío.
    2. Llama a generar_respuesta_ia que encapsula toda la lógica de contexto y OpenAI.
...
def debug_prompt():
    """
    Endpoint para devolver el prompt final que se enviaría a OpenAI, sin generar la respuesta.
...
def enviar_formulario_digitalizar():
    ...
    2. Un resumen en prosa para el cliente usando OpenAI.
    ...
    try:
        ...
        # ✅ Generar resumen en prosa usando OpenAI
